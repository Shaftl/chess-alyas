            ...
            {serverGeo && (
              <div className={styles.geoInfo}>
                ...
                <div className={styles.geoDetails}>
                  ...
                  {/* <span>
                    {serverGeo.country || "Unknown"}
                    {serverGeo.ip && ` — ${serverGeo.ip}`}
                  </span> */}
                </div>
              </div>
            )}
